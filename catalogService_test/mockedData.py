...
xenent_listPools1 = ({'Status' : 'Success',
  'Value' : {
    'OpaqueRef:poolRef1': {
        ...
        'main': 'OpaqueRef:d3565cb8-5de8-5562-a92a-6ce52fbde613',
...
xenent_pool_get_main1 = ({'Status' : 'Success',
  'Value' : 'OpaqueRef:poolMain1',
}, )
    ...
    'Value' :
{
  'OpaqueRef:7afb1580-5af9-b175-d85f-3b2abf5402d1' : {   'DNS': '',
    ...
    'MTU': '1500',
    'VLAN': '-1',
    'VLAN_main_of': 'OpaqueRef:NULL',
    'VLAN_subordinate_of': [],
    'bond_main_of': [],
    'bond_subordinate_of': 'OpaqueRef:NULL',
...
vmwareReqGetVirtualMachineProps1 = _vmwareReqRetrievePropertiesTemplate % (
  ...
  '<objectSet>'
    ...
    '<ns1:skip>false</ns1:skip>'
    '<selectSet xsi:type="ns1:SelectionSpec"><ns1:name>visitFolders</ns1:name>'
    '</selectSet></selectSet>'
    '<selectSet xsi:type="ns1:TraversalSpec">'
...
vmwareRetrievePropertiesVMReq35_hwdev = (
    ...
    ' xsi:type="ns1:ManagedObjectReference">vm-4739<',
    '>vm-987<').replace(
        '<selectSet xsi:type="ns1:SelectionSpec"><ns1:name>HToVm</ns1:name></selectSet>'
        '<selectSet xsi:type="ns1:SelectionSpec"><ns1:name>rpToVm</ns1:name></selectSet>',
        '<selectSet xsi:type="ns1:SelectionSpec"><ns1:name>HToVm</ns1:name></selectSet>'
        '<selectSet xsi:type="ns1:SelectionSpec"><ns1:name>rpToVm</ns1:name></selectSet>'
        '<selectSet xsi:type="ns1:SelectionSpec"><ns1:name>dcToNetwork</ns1:name></selectSet>').replace(
    '</objectSet>',
    '<selectSet xsi:type="ns1:TraversalSpec">'
      '<ns1:name>dcToNetwork</ns1:name>'
      '<ns1:type>Datacenter</ns1:type>'
