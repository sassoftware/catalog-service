...
class OpenStackClient(baseDriver.BaseDriver):
    ...
    RBUILDER_BUILD_TYPE = 'XEN_OVA'  # TODO: Determin appropriate rBuilder image type
    ...
    def drvCreateCloudClient(self, credentials):
        ...
        try:
            ...
            clients = ConsolidatedClients(nova_client, glance_client)
    ...
    #### PROGRESS INCOMPLETE THROUGH HERE ####
